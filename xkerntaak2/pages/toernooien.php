            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="crud/createtournament.php" class="btn pull-right" style="background-color:#ff9623;"><i
                                class="fa fa-plus"></i> Nieuw Toernooi</a>
                    </div>
                </div>
                <?php
                        ...
                        <tr>
                            ...
                            <th>
                                <a href="crud/editplayer.php?id=<?php echo $result['ID'] ?>" class="mr-3"
                                    title="Speler Bewerken" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>
                                <a href="crud/deleteplayer.php?id=<?php echo $result['ID'] ?>"
                                    title="Speler Verwijderen" data-toggle="tooltip"><span
